                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 20,),
                      LableInfo(header: "Equipment ID", name: widget.equipment.id),
                      SizedBox(height: 10,),
                      LableInfo(header: "Name", name: widget.equipment.name),
                      SizedBox(height: 10,),
                      ...
                      // SizedBox(height: 10,),
                      // LableInfo(header: "Status", name: widget.equipment?.status != 1 ? "Inactive" : "Active"),
                      // SizedBox(height: 10,),
